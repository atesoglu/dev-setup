...
echo "🚀 Starting infrastructure containers using Podman..."
podman-compose -f elk/docker-compose.yml -f database/docker-compose.yml -p "dev-resources" up -d
...
echo "✅ All services are up and running under Podman."